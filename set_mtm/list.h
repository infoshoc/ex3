...
* @param list The list for which the current element will be removed
* @return
* NULL if list is NULL or if the current pointer of the list is in invalid
* state, a pointer to the removed element otherwise.
*/
ListElement listExtractCurrent(List list);
